...
| <a name="input_ns_record_ttl"></a> [ns\_record\_ttl](#input\_ns\_record\_ttl) | The time to live (TTL) of the nameserver Route53 record, in seconds. | `number` | `172800` | no |
...
| <a name="input_soa_record_ttl"></a> [soa\_record\_ttl](#input\_soa\_record\_ttl) | The time to live (TTL) of the start of authority Route53 record, in seconds. | `number` | `900` | no |
